...
onready var hp_bar = get_node("HUD/InfoBar/H/HPBar")
onready var hp_bar_tween = get_node("HUD/InfoBar/H/HPBar/Tween")
...
func set_tower_preview(tower_type, mouse_position):
	...
	var texture = load("res://Assets/UI/transparentRange.png")
